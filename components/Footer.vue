    ...
    <div class="container-custom">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-12 border-b border-gray-700 pb-12">
        ...
        <div>
          ...
          <form class="flex w-full">
            <input type="email" placeholder="Stay updated on new publications"
      ...
      <div class="pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <p class="text-gray-400 text-xs">
          &copy; {{ new Date().getFullYear() }} Dr. John Kayode Fayemi. All Rights Reserved.
        </p>
      </div>
    </div>
  </footer>
...
const navLinks = [
  ...
  { name: "Key Achievements", path: "/achievements" },
